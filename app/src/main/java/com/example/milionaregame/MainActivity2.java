...
import com.example.milionaregame.adapter.TienThuongAdapter;
import com.example.milionaregame.object.CauHoi;
import com.example.milionaregame.object.FaceData;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void checkCauTraLoi(final TextView txv) {
        ...
        txv.setBackgroundResource(R.drawable.bg_cauchon);
            ...
            public void onFinish() {
                for (TextView t : arrTxvCauTraLoi) {
                    ...
                    if (s.equals(cauHoi.getDapAnDung())) {
                        t.setBackgroundResource(R.drawable.bg_caudung);
                        break;
                    }
                }
                new CountDownTimer(2000, 100) {
    ...
    public void hienCauHoi() {
        ...
        for (int i = 0; i < arrTxvCauTraLoi.size(); i++) {
            ...
            arrTxvCauTraLoi.get(i).setBackgroundResource(R.drawable.btn_bg);
